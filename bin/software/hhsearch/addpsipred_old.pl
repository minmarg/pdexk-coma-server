...
my $ncbidir="/usr/local/install/blast/blast-2.2.18/bin";           # Put the directory path with the BLAST executables 
my $perl="/home/minlag/Documents/svm_project/hhpred_method/hhsearch";                 # Put the directory path where reformat.pl is lying
my $dummydb="/home/minlag/Documents/svm_project/hhpred_method/do_no_delete"; # Put the name given to the dummy blast directory (or leave this name)

my $psipreddir="/home/minlag/Documents/svm_project/hhpred_method/psipred";     # Put the directory path with the PSIPRED executables 
